package com.il360.shenghecar.util.alipay;
...
public class CreditAuthHelper {
	...
	public static void creditAuth(final Activity activity, String appid, String params, String sign,
			Map<String, String> extParams, ICreditListener listener) {
