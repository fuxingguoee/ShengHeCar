...
public class MyApplication extends android.support.multidex.MultiDexApplication {
	...
	public void onCreate() {
		...
		OctopusManager.getInstance().init(this,Variables.MH_PARTNER_CODE,Variables.MH_PARTNER_KEY);
		MoxieSDK.init(this);
	}
	
	private void initAnalytics() {
		// 统计初始化(第三个参数是消息推送的UMENG_MESSAGE_SECRET)
		UMConfigure.init(this, UMConfigure.DEVICE_TYPE_PHONE, "1a0f1ee271c27b8d28daaa89844d5502");
	}
