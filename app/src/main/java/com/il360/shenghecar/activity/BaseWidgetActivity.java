...
public abstract class BaseWidgetActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setBackgroundDrawable(ContextCompat.getDrawable(BaseWidgetActivity.this, R.color.main_logo));
...
//    public abstract void parseResponseData(MessageParameter mp) throws JSONException;
//
//    public abstract String prepareURL(MessageParameter mp) throws JSONException;
//
//    public abstract void parseNullData(MessageParameter mp);
}
