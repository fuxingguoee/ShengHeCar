...
import com.il360.shenghecar.activity.home.SignNameActivity;
...
//	@Extra Order order;
//	@Extra int type;
	@Extra String orderNo,principal;//订单号，金额
...
//		transDialog = ProgressDialog.show(DealRuleActivity.this, null, "加载中...", true);
		...
		wv_show.loadUrl("http://www.wxkj2018.com/xjsc/xjsc-loan-agreement.html"
				+ "?orderNo=" + orderNo
				+ "&name=" + GlobalPara.getOutUserRz().getName()
				+ "&idCard=" + GlobalPara.getOutUserRz().getIdNo()
				+ "&tel=" + UserUtil.getUserInfo().getLoginName()
				+ "&principal=" + principal); // 加载在线网页
